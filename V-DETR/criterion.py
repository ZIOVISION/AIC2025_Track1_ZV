...
class SetCriterion(nn.Module):
    ...
    def loss_angle(self, outputs, targets, assignments):
        ...
        angle_residual = outputs["angle_residual_normalized"]
        #print('angle_residual_pred',angle_residual)
        ...
        if targets["num_boxes_replica"] > 0:
            ...
            #print('gt_angle_residual',gt_angle_residual_normalized)
            ...
            #print('angle_residual_for_gt_class',angle_residual_for_gt_class)
            #print('gt_angle_residual_normalized',gt_angle_residual_normalized)
            angle_reg_loss = huber_loss(
                angle_residual_for_gt_class - gt_angle_residual_normalized, delta=1.0
            )
            #print('angle_reg_loss',angle_reg_loss)
            ...
            #print("angle_reg_loss sum", angle_reg_loss)
        ...
        #print({"loss_angle_cls": angle_cls_loss, "loss_angle_reg": angle_reg_loss})
    ...
    def repeat_ground_truth(self, maingt_repeat, batch_data_label):
        ...
        for b in range(batch_size):
            ...
            for k in batch_data_label_multi.keys():
                if k not in  ["file_names","nactual_gt","num_boxes","num_boxes_replica",'scan_idx']:
